...
import {signupDB} from '../connection/axios'
        ...
        messageBox && <div className={mode?`messageLight ${messageType}`:`messageDark ${messageType}`}>
         ...
         <div className='form-container'>
            ...
            <form className='form_input'>
                <input type="email" placeholder='Email' className={mode?"light_input_form":'dark_input_form'} required/>
                <input type="password" placeholder='Password' className={mode?"light_input_form":'dark_input_form'} required/>
